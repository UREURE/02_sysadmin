...
--
-- Host: localhost    Database: mediawikidb
-- ------------------------------------------------------
...
--
-- Table structure for table `my_wikichange_tag_def`
--

DROP TABLE IF EXISTS `my_wikichange_tag_def`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `my_wikichange_tag_def` (
...
--
-- Dumping data for table `my_wikichange_tag_def`
--

LOCK TABLES `my_wikichange_tag_def` WRITE;
/*!40000 ALTER TABLE `my_wikichange_tag_def` DISABLE KEYS */;
/*!40000 ALTER TABLE `my_wikichange_tag_def` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `my_wikicontent` VALUES (1,788,'ko227abvr8dfykm68hs18vpec4wadws',1,'tt:1');
...
INSERT INTO `my_wikicontent_models` VALUES (1,'wikitext');
...
--
-- Table structure for table `my_wikiipblocks_restrictions`
--

DROP TABLE IF EXISTS `my_wikiipblocks_restrictions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `my_wikiipblocks_restrictions` (
...
--
-- Dumping data for table `my_wikiipblocks_restrictions`
--

LOCK TABLES `my_wikiipblocks_restrictions` WRITE;
/*!40000 ALTER TABLE `my_wikiipblocks_restrictions` DISABLE KEYS */;
/*!40000 ALTER TABLE `my_wikiipblocks_restrictions` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `my_wikijob` VALUES (1,'userGroupExpiry',0,'Página_principal','20190715210621','a:1:{s:9:\"requestId\";s:24:\"9dc6f8b393aefab4cbead70d\";}',1346095859,0,'',NULL,'3r0mhy0xnb21udyeco4aoye3px6fi4q');
...
INSERT INTO `my_wikilog_search` VALUES ('associated_rev_id','1',1);
...
INSERT INTO `my_wikilogging` VALUES (1,'create','create','20190715210621',0,'MediaWiki default',0,0,'Página_principal',1,'',0,'a:1:{s:17:\"associated_rev_id\";i:1;}',0);
...
INSERT INTO `my_wikipage` VALUES (1,0,'Página_principal','',0,1,0.527872753757,'20190715210621',NULL,1,788,'wikitext',NULL);
...
INSERT INTO `my_wikirevision` VALUES (1,1,1,'',0,'MediaWiki default','20190715210621',0,0,788,0,'ko227abvr8dfykm68hs18vpec4wadws',NULL,NULL);
...
INSERT INTO `my_wikislot_roles` VALUES (1,'main');
...
INSERT INTO `my_wikislots` VALUES (1,1,1,1);
...
INSERT INTO `my_wikiuser` VALUES (1,'Ure','',':pbkdf2:sha512:30000:64:FaehVvdsTy6KripFsIG2Ng==:c4qveeRVwpPkRhjuUBd7KnyaHfhh8VTApoC5TLGw8ihlE4SFSxmQrnT6LmZ5gUzvfwrb94DKmQLmKUyrOboO4g==','',NULL,'aureliopn@gmail.com','20190715210628','9b06f896857bcce51e9a923aa3041570',NULL,NULL,NULL,'20190715210621',0,NULL);
...
INSERT INTO `my_wikiuser_groups` VALUES (1,'bureaucrat',NULL),(1,'interface-admin',NULL),(1,'sysop',NULL);
...
-- Dump completed on 2019-07-15 21:14:20
